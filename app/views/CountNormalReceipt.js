...
export default class CountNormalReceipt extends React.Component {
  state = {
    loading: true, 
    data: [1],
    modalVisible: false,
        ...
        <Modal
          ...
          <View padder style={{margin: 22}}>
            <View>
              ...
              <Text note style={{textAlign:'center'}} padder> За пресмятането на необходимите блокове за
              готова рецепта, моля въвете в секция к-во точното количество в грамове за конкретен продукт. 
